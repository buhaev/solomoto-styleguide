...
**Do not nest selectors except for the cases [described in BEM](https://en.bem.info/methodology/css/#nested-selectors)**
...
Based on [Airbnb Style Guide](https://github.com/airbnb/css)
